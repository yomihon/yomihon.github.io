...
description: Essential information to help you get set up with Yomihon.
---
...
Essential information to help you get set up with Yomihon.

## Installation guide

### Downloading Yomihon

1. Visit our [download](/download/) page to get the latest version of **Yomihon**.
2. After the download is complete, open the `.apk` file.
3. Proceed with the installation process.

### Adding sources

Once **Yomihon** is installed on your device, you can bring your own content to read from various sources:
...
External repositories add additional sources to **Yomihon**:
...
::: danger Caution
Yomihon will not provide resources for any unofficial repositories. Beware that any third-party repositories or extensions will have full access to the app and may contain malware.
:::
...
::: danger Caution
Yomihon will not provide resources for any unofficial extensions. Beware that any third-party repositories or extensions will have full access to the app and may contain malware.
:::
::::
...
Now that you're set up, check out the [Dictionaries](/docs/guides/dictionaries) guide to learn how to look up words while reading.
